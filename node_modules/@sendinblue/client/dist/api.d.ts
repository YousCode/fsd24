...
export declare class CompanyAttributes extends Array<CompanyAttributesInner> {
    static discriminator: string | undefined;
}
...
export declare class DealAttributes extends Array<DealAttributesInner> {
    static discriminator: string | undefined;
}
...
export declare class FileList extends Array<FileData> {
    static discriminator: string | undefined;
}
...
export declare class GetExtendedContactDetailsStatisticsDelivered {
    'campaignId': number;
    'eventTime': string;
    static discriminator: string | undefined;
    static attributeTypeMap: Array<{
...
export declare class GetInboundEmailEventsByUuidAttachments {
    'name'?: string;
    'contentType'?: string;
    'contentId'?: string;
...
export declare class GetInboundEmailEventsByUuidLogs {
    'date'?: Date;
...
export declare namespace GetInboundEmailEventsByUuidLogs {
    enum TypeEnum {
        Received,
        Processed,
        WebhookFailed,
...
export declare class GetInboundEmailEventsEvents {
    'uuid': string;
    'date': Date;
    'sender': string;
    'recipient': string;
...
export declare class GetScheduledEmailByBatchIdBatches {
    'scheduledAt': Date;
    'createdAt': Date;
...
export declare namespace GetScheduledEmailByBatchIdBatches {
    enum StatusEnum {
        InProgress,
        Queued,
        Processed,
...
export declare class MasterDetailsResponsePlanInfoFeatures {
    'name'?: string;
    'unitValue'?: string;
    'quantity'?: number;
    'used'?: number;
...
export declare class NoteList extends Array<Note> {
    static discriminator: string | undefined;
}
...
export declare class SubAccountDetailsResponsePlanInfoFeaturesInbox {
    'quantity'?: number;
    'remaining'?: number;
    static discriminator: string | undefined;
    static attributeTypeMap: Array<{
...
export declare class SubAccountsResponseSubAccounts {
    'id': number;
    'companyName': string;
    'active': boolean;
    'createdAt': number;
...
export declare class UpdateBatchContactsContacts {
    'email'?: string;
    'id'?: number;
    'sms'?: string;
    'attributes'?: {
...
export declare class CompaniesApi {
    ...
    companiesAttributesGet(options?: any): Promise<{
        response: http.IncomingMessage;
        body: CompanyAttributes;
    }>;
    companiesGet(filters?: string, linkedContactsIds?: number, linkedDealsIds?: string, page?: number, limit?: number, sort?: 'asc' | 'desc', sortBy?: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: CompaniesList;
    }>;
    companiesIdDelete(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    companiesIdGet(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: Company;
    }>;
    companiesIdPatch(id: string, body: Body1, options?: any): Promise<{
        response: http.IncomingMessage;
        body: Company;
    }>;
    companiesLinkUnlinkIdPatch(id: string, body: Body2, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    companiesPost(body: Body, options?: any): Promise<{
        response: http.IncomingMessage;
...
export declare class ContactsApi {
    ...
    getContactInfo(identifier: string, startDate?: any, endDate?: any, options?: any): Promise<{
        response: http.IncomingMessage;
    ...
    updateBatchContacts(updateBatchContacts: UpdateBatchContacts, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
...
export declare class ConversationsApi {
    ...
    conversationsAgentOnlinePingPost(body: Body12, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    conversationsMessagesIdDelete(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    conversationsMessagesIdGet(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: ConversationsMessage;
    }>;
    conversationsMessagesIdPut(id: string, body?: Body9, options?: any): Promise<{
        response: http.IncomingMessage;
        body: ConversationsMessage;
    }>;
    conversationsMessagesPost(body: Body8, options?: any): Promise<{
        response: http.IncomingMessage;
        body: ConversationsMessage;
    }>;
    conversationsPushedMessagesIdDelete(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    conversationsPushedMessagesIdGet(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: ConversationsMessage;
    }>;
    conversationsPushedMessagesIdPut(id: string, body: Body11, options?: any): Promise<{
        response: http.IncomingMessage;
        body: ConversationsMessage;
    }>;
    conversationsPushedMessagesPost(body: Body10, options?: any): Promise<{
        response: http.IncomingMessage;
        body: ConversationsMessage;
    }>;
}
...
export declare class DealsApi {
    ...
    crmAttributesDealsGet(options?: any): Promise<{
        response: http.IncomingMessage;
        body: DealAttributes;
    }>;
    crmDealsGet(filterAttributes?: string, filterLinkedCompaniesIds?: string, filterLinkedContactsIds?: string, offset?: number, limit?: number, sort?: 'asc' | 'desc', sortBy?: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: DealsList;
    }>;
    crmDealsIdDelete(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    crmDealsIdGet(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: Deal;
    }>;
    crmDealsIdPatch(id: string, body: Body4, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    crmDealsLinkUnlinkIdPatch(id: string, body: Body5, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    crmDealsPost(body: Body3, options?: any): Promise<{
        response: http.IncomingMessage;
        body: InlineResponse201;
    }>;
    crmPipelineDetailsGet(options?: any): Promise<{
        response: http.IncomingMessage;
        body: Pipeline;
    }>;
}
...
export declare class FilesApi {
    ...
    crmFilesGet(entity?: 'companies' | 'deals' | 'contacts', entityIds?: string, dateFrom?: number, dateTo?: number, offset?: number, limit?: number, sort?: 'asc' | 'desc', options?: any): Promise<{
        response: http.IncomingMessage;
        body: FileList;
    }>;
    crmFilesIdDataGet(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: FileData;
    }>;
    crmFilesIdDelete(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    crmFilesIdGet(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: FileDownloadableLink;
    }>;
    crmFilesPost(file: Buffer, dealId?: string, contactId?: number, companyId?: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: FileData;
    }>;
}
...
export declare class InboundParsingApi {
    ...
    getInboundEmailAttachment(downloadToken: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: Buffer;
    }>;
    getInboundEmailEvents(sender?: string, startDate?: string, endDate?: string, limit?: number, offset?: number, sort?: 'asc' | 'desc', options?: any): Promise<{
        response: http.IncomingMessage;
        body: GetInboundEmailEvents;
    }>;
    getInboundEmailEventsByUuid(uuid: string, options?: any): Promise<{
        response: http.IncomingMessage;
...
export declare class MasterAccountApi {
    ...
    corporateMasterAccountGet(options?: any): Promise<{
        response: http.IncomingMessage;
        body: MasterDetailsResponse;
    }>;
    corporateSubAccountGet(offset: number, limit: number, options?: any): Promise<{
        response: http.IncomingMessage;
        body: SubAccountsResponse;
    }>;
    corporateSubAccountIdDelete(id: number, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    corporateSubAccountIdGet(id: number, options?: any): Promise<{
        response: http.IncomingMessage;
        body: SubAccountDetailsResponse;
    }>;
    corporateSubAccountIdPlanPut(id: number, updatePlanDetails: SubAccountUpdatePlanRequest, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    corporateSubAccountPost(subAccountCreate: CreateSubAccount, options?: any): Promise<{
        response: http.IncomingMessage;
        body: CreateSubAccountResponse;
    }>;
    corporateSubAccountSsoTokenPost(ssoTokenRequest: SsoTokenRequest, options?: any): Promise<{
        response: http.IncomingMessage;
        body: GetSsoToken;
    }>;
}
...
export declare class NotesApi {
    ...
    crmNotesGet(entity?: 'companies' | 'deals' | 'contacts', entityIds?: string, dateFrom?: number, dateTo?: number, offset?: number, limit?: number, sort?: 'asc' | 'desc', options?: any): Promise<{
        response: http.IncomingMessage;
        body: NoteList;
    }>;
    crmNotesIdDelete(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    crmNotesIdGet(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: Note;
    }>;
    crmNotesIdPatch(id: string, body: NoteData, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    crmNotesPost(body: NoteData, options?: any): Promise<{
        response: http.IncomingMessage;
        body: NoteId;
    }>;
}
...
export declare class TasksApi {
    ...
    crmTasksGet(filterType?: string, filterStatus?: 'done' | 'undone', filterDate?: 'overdue' | 'today' | 'tomorrow' | 'week' | 'range', filterAssignTo?: string, filterContacts?: string, filterDeals?: string, filterCompanies?: string, dateFrom?: number, dateTo?: number, offset?: number, limit?: number, sort?: 'asc' | 'desc', sortBy?: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: TaskList;
    }>;
    crmTasksIdDelete(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    crmTasksIdGet(id: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body: Task;
    }>;
    crmTasksIdPatch(id: string, body: Body7, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    crmTasksPost(body: Body6, options?: any): Promise<{
        response: http.IncomingMessage;
        body: InlineResponse2011;
    }>;
    crmTasktypesGet(options?: any): Promise<{
        response: http.IncomingMessage;
        body: TaskTypes;
    }>;
}
...
export declare class TransactionalEmailsApi {
    ...
    deleteScheduledEmailById(identifier: string, options?: any): Promise<{
        response: http.IncomingMessage;
        body?: any;
    }>;
    ...
    getScheduledEmailByBatchId(batchId: string, startDate?: string, endDate?: string, sort?: 'asc' | 'desc', status?: 'processed' | 'inProgress' | 'queued', limit?: number, offset?: number, options?: any): Promise<{
        response: http.IncomingMessage;
        body: GetScheduledEmailByBatchId;
    }>;
    getScheduledEmailByMessageId(messageId: string, startDate?: string, endDate?: string, options?: any): Promise<{
        response: http.IncomingMessage;
...
export declare class WebhooksApi {
    ...
    getWebhooks(type?: 'marketing' | 'transactional' | 'inbound', sort?: 'asc' | 'desc', options?: any): Promise<{
        response: http.IncomingMessage;
        body: GetWebhooks;
    }>;
